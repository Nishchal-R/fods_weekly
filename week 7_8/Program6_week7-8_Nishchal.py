...
This program prompts the user to input at least 10 numbers and stores them in a list.
It then converts the list into a NumPy array, sorts the array in ascending order,
and performs slicing operations to retrieve elements between specific index ranges:
indexes 2 to 5, 5 to 8, and 2 to 9.

The program demonstrates basic list handling, user input, array sorting,
and slicing using NumPy.
'''
